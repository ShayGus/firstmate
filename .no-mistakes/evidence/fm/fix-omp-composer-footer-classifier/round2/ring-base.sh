...
set -u
R=/tmp/fm-omp-base-d4f3b78
E=/home/shayg/.no-mistakes/evidence/01M39SN6G9D40EFA3V9GBC85A0/round2
S=$(cat $E/lab-session.txt)
unset HERDR_ENV HERDR_PANE_ID HERDR_TAB_ID HERDR_WORKSPACE_ID HERDR_SOCKET_PATH HERDR_SESSION
export HERDR_LAB_SESSION=$S HERDR_ORIGINAL_PATH=$PATH HERDR_LAB_HELPER=/home/shayg/.no-mistakes/worktrees/f4bb769f35f8/01M39SN6G9D40EFA3V9GBC85A0/bin/fm-herdr-lab.sh
